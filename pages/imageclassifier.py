...
st.set_page_config(layout="wide", page_title="Image Classification for Wild Cats")

# Function to load the model
def load_model():
    try:
        model = joblib.load('pages/wildcats_.p')
        return model
...
st.write("## 🦁 Image Classification for Wild Cats 🐆")
...
def fix_image(upload):
    ...
    col2.write("### Predicted Breed :bone:")
